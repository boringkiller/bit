...
/**
 * DealHistory generated by hbm2java
 */
@Entity
@Table(name = "deal_history", catalog = "test")
public class DealHistory implements java.io.Serializable {
	...
	public DealHistory(int iddeal) {
		this.iddeal = iddeal;
	}

	public DealHistory(int iddeal, String buyer, String seller,
			String idbuying, String idselling, String initiator, String memo,
			String price, String quantity, Date createTs, Date modifyTs) {
		this.iddeal = iddeal;
		this.buyer = buyer;
		this.seller = seller;
